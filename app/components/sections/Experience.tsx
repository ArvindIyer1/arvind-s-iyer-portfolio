...
import { education, experience as experienceData, type ExperienceItem } from "@/config/experience"
  ...
  return (
    <>
      ...
      >
        ...
        <div className={experiences.length > 0 ? "mt-7" : ""}>
          <p
          ...
          >
            <div className="flex items-baseline justify-between gap-4 mb-1.5">
              <span className="text-[14px] font-semibold text-white">{education.school}</span>
              <span className="font-mono text-[10px] flex-none" style={{ color: "var(--text-faint)" }}>
                {education.period}
              </span>
            </div>
